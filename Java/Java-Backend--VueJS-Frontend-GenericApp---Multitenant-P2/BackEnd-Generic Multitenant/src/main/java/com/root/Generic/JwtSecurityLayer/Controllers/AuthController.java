...
public class AuthController {
        ...
        public ResponseEntity<?> registerUser(@Valid @RequestBody SignUpRequest signUpRequest,
                        @PathVariable("role") String role) {
                                ...
                                System.out.println(signUpRequest.getEmpresa());
                                System.out.println(signUpRequest.getUrlServer());
                                System.out.println(signUpRequest.getDatabase());
                                System.out.println(signUpRequest.getTenantId());
                                System.out.println(signUpRequest.getNitempresa());
