...
public class AwsSqsReaderNoMaven {

    public static void main(String[] args) {

        String accessKey = "AKIAR4GJAHA3TEAUHH";
        String secretKey = "4HFrqCVwKGcJtaq3p/OkVSKehcht3NL6jOnSZ";
        ...
        try {
            ...
            for (final Message message : messages) {
                ...
                try {
                    ...
                    Logger.getLogger(AwsSqsReaderNoMaven.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
            System.out.println();
    ...
    public static void getItemstoJSON(String jsonString) throws ParseException {
